...
static void mavlink_test_mavlink/message_definitions/v1.0/common(uint8_t, uint8_t, mavlink_message_t *last_msg);
static void mavlink_test_mavlink/message_definitions/v1.0/ardupilotmega(uint8_t, uint8_t, mavlink_message_t *last_msg);
static void mavlink_test_openhd(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_mavlink/message_definitions/v1.0/common(system_id, component_id, last_msg);
    mavlink_test_mavlink/message_definitions/v1.0/ardupilotmega(system_id, component_id, last_msg);
    mavlink_test_openhd(system_id, component_id, last_msg);
}
#endif

#include "../mavlink/message_definitions/v1.0/common/testsuite.h"
#include "../mavlink/message_definitions/v1.0/ardupilotmega/testsuite.h"
