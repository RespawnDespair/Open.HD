#pragma once
// MESSAGE OPENHD_AIR_TELEMETRY PACKING
...
/**
 * @brief Pack a openhd_air_telemetry message
 ...
 * @param injection_fail_cnt  injection_fail_cnt
                               ...
                               uint8_t target_system, uint8_t target_component, uint32_t damaged_block_cnt, uint32_t lost_packet_cnt, uint32_t skipped_packet_cnt, uint32_t injection_fail_cnt, uint8_t current_signal_dbm)
{
...
#else
    mavlink_openhd_air_telemetry_t packet;
    ...
    msg->msgid = MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_MIN_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_CRC);
}

/**
 * @brief Pack a openhd_air_telemetry message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
                                   ...
                                   uint8_t target_system,uint8_t target_component,uint32_t damaged_block_cnt,uint32_t lost_packet_cnt,uint32_t skipped_packet_cnt,uint32_t injection_fail_cnt,uint8_t current_signal_dbm)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_MIN_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_CRC);
}

/**
 * @brief Encode a openhd_air_telemetry struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param openhd_air_telemetry C-struct to read the message contents from
 */
...
/**
 * @brief Encode a openhd_air_telemetry struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
#if MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
...
static inline void mavlink_msg_openhd_air_telemetry_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint32_t damaged_block_cnt, uint32_t lost_packet_cnt, uint32_t skipped_packet_cnt, uint32_t injection_fail_cnt, uint8_t current_signal_dbm)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY, buf, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_MIN_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_LEN, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_CRC);
#else
    mavlink_openhd_air_telemetry_t *packet = (mavlink_openhd_air_telemetry_t *)msgbuf;
    packet->damaged_block_cnt = damaged_block_cnt;
    packet->lost_packet_cnt = lost_packet_cnt;
    packet->skipped_packet_cnt = skipped_packet_cnt;
    packet->injection_fail_cnt = injection_fail_cnt;
 ...
 */
static inline uint32_t mavlink_msg_openhd_air_telemetry_get_damaged_block_cnt(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  0);
}

/**
 * @brief Get field lost_packet_cnt from openhd_air_telemetry message
 *
 * @return  lost_packet_cnt
 */
static inline uint32_t mavlink_msg_openhd_air_telemetry_get_lost_packet_cnt(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  4);
}

/**
 * @brief Get field skipped_packet_cnt from openhd_air_telemetry message
 *
 * @return  skipped_packet_cnt
 */
static inline uint32_t mavlink_msg_openhd_air_telemetry_get_skipped_packet_cnt(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  8);
}

/**
 * @brief Get field injection_fail_cnt from openhd_air_telemetry message
 *
 * @return  injection_fail_cnt
 */
static inline uint32_t mavlink_msg_openhd_air_telemetry_get_injection_fail_cnt(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  12);
}

/**
 * @brief Get field current_signal_dbm from openhd_air_telemetry message
 *
...
/**
 * @brief Decode a openhd_air_telemetry message into a struct
 *
 * @param msg The message to decode
 * @param openhd_air_telemetry C-struct to decode the message contents into
 */
static inline void mavlink_msg_openhd_air_telemetry_decode(const mavlink_message_t* msg, mavlink_openhd_air_telemetry_t* openhd_air_telemetry)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    openhd_air_telemetry->damaged_block_cnt = mavlink_msg_openhd_air_telemetry_get_damaged_block_cnt(msg);
    ...
    openhd_air_telemetry->current_signal_dbm = mavlink_msg_openhd_air_telemetry_get_current_signal_dbm(msg);
        ...
        memset(openhd_air_telemetry, 0, MAVLINK_MSG_ID_OPENHD_AIR_TELEMETRY_LEN);
    memcpy(openhd_air_telemetry, _MAV_PAYLOAD(msg), len);
#endif
}
